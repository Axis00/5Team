...
const qnaList = [

	{
		...
		a: [
			...
			{ answer: '이제 슬슬 분위기가 물올랐어, 같이 즐길 수 있는 노래를 부른다.', type: [1] }
		]
	},
	{
		...
		a: [
			...
			{ answer: '부모님에게 트렌드를 알려줄 요즘 노래를 부른다.', type: [1] }
		]
	},
	{
		q: '3. 절친의 결혼식에 축가를 부르게 되었다. 당신의 선곡은? ',
		a: [
			{ answer: '최선을 다해 발라드를 불러 친구를 감동시킨다. ', type: [2] },
	...
	},
	{
		...
		a: [
			...
			{ answer: '새벽 감성이 올라온다. 전 애인과 즐겨들었던 노래를 들으며 그녀를 추억한다.', type: [1] }
		]
	},
	{
		...
		a: [
			...
			{ answer: '왕이 되는 이 기분을 숨겨왔던 나의 댄스 실력으로 보여준다.', type: [4] }
		]
	},
	{
	...
	},
	{
		...
		a: [
			{ answer: '스트레스를 풀 때는 고음만 한 게 없지. ', type: [7] },
			{ answer: '댄스음악을 들으며 춤을 추면서 나는 이런 사람이라는 것을 일깨운다. ', type: [6] }
		]
	},
	{
		q: '8. 친구들에게 1년 전부터 괴롭힘을 당하고 있다. 집에 가서 나를 위로해 주는 것은?',
		a: [
			{ answer: '슬픈 발라드를 들으며 나를 위로한다.', type: [4] },
...

	{
		q: '9. 운동을 하러온 나를 위해',
		a: [
			{ answer: '운동에 집중할 수 있는 서정적인 노래', type: [5] },
			{ answer: '나에게 힘을 불어넣어 주는 강렬한 노래', type: [4] }
		]
	},
	{
